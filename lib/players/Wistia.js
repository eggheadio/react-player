  ...
  _createClass(Wistia, [{
    ...
    value: function componentDidMount() {
      ...
      this.getSDK().then(function () {
        ...
        window._wq.push({
          id: _this2.getID(_this2.props.wistia_url || _this2.props.url),
    ...
    value: function load(nextProps) {
      ...
      var id = this.getID(nextProps.wistia_url || nextProps.url);
      this.unbind();
    ...
    value: function render() {
      var id = this.getID(this.props.wistia_url);
      var className = 'wistia_embed wistia_async_' + id + ' videoFoam=true playerColor=171e27';
      var style = {
        width: '100%',
        height: '100%',
