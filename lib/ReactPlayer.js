...
var _Bitmovin = require('./players/Bitmovin');

var _Bitmovin2 = _interopRequireDefault(_Bitmovin);
...
var ReactPlayer = function (_Component) {
  ...
  function ReactPlayer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReactPlayer.__proto__ || Object.getPrototypeOf(ReactPlayer)).call.apply(_ref, [this].concat(args))), _this), _this.seekTo = function (fraction) {
      ...
      var hasUrl = _this.props.dash_url || _this.props.hls_url || _this.props.wistia_url;
      if (hasUrl && _this.player) {
      ...
      var url = _this.props.dash_url || _this.props.hls_url || _this.props.wistia_url;
      var active = Player.canPlay(url);
  ...
  _createClass(ReactPlayer, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      return url !== nextUrl || this.props.playing !== nextProps.playing || this.props.volume !== nextProps.volume || this.props.playbackRate !== nextProps.playbackRate || this.props.height !== nextProps.height || this.props.width !== nextProps.width || this.props.hidden !== nextProps.hidden;
    }
  }, {
    key: 'renderPlayers',
    value: function renderPlayers() {
      ...
      } else if (_Bitmovin2['default'].canPlay(url)) {
        console.log('-------- BITMOVIN', url);
        players.push(_Bitmovin2['default']);
